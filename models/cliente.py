...
class Cliente:
    ...
    @property
    def data_nascimento(self: object) -> date:
        return self.__data_nascimento

    @property
    def data_cadastro(self: object) -> date:
        return self.__data_cadastro

    def __str__(self: object) -> str:
        return f'Código: {self.codigo} \nNome: {self.nome} \nData de Nascimento: {date_para_str(self.data_nascimento)} \nCadastro: {date_para_str(self.data_cadastro)}'
